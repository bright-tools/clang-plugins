...
template <>
struct MappingContextTraits<brighttools::BannedString, brighttools::BannedStringContext> {
    static void mapping(IO &io, brighttools::BannedString &info,
        ...
        const std::string enableRegexFieldName =
            std::string("Enable") + context.stringAlias.data() + "Regex";
